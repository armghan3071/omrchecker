/**
 * src/schemas/template_schema.js
 */
import { FIELD_TYPES } from '../constants.js';
import { ARRAY_OF_STRINGS, FIELD_STRING_TYPE } from './constants.js';

const positive_number = {"type": "number", "minimum": 0};
const positive_integer = {"type": "integer", "minimum": 0};

const two_positive_integers = {
    "type": "array",
    "prefixItems": [
        positive_integer,
        positive_integer,
